...
LAYOUT(
    {
        ...
        LEADER_KEY, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)), L(VISIT, 1), K(US_SC(' ')), K(US_SC(' ')), L(VISIT, 2), MA(K(US_SC('a')), K(US_SC('b'))), HTA(K(US_SC(R_SHIFT)),  TDA(K(US_SC('a')), K(US_SC('b')))),  OSA(K(US_SC(R_ALT))), HTA(K(US_SC(R_GUI)),  TDA(NO_ACTION,  OSA(K(US_SC(R_SHIFT)))))
    },
    {
