...
LAYOUT(
    {
        ...
        K(SC(US, ESC)), K(SC(US, 'a')), K(SC(US, 's')), K(SC(US, 'd')), K(SC(US, 'f')), K(SC(US, 'g')), K(SC(US, 'h')), TH(K(SC(US, 'j')), K(SC(US, R_ALT))), K(SC(US, 'k')), K(SC(US, 'l')), K(SC(US, ';')), K(SC(US, '\'')),
    ...
    },
    {
        ...
        RESET, K(SC(US, L_CTRL)), K(SC(US, L_ALT)), K(SC(US, L_GUI)), L(VISIT, 1), K(SC(US, ' ')), K(SC(US, ' ')), L(VISIT, 2), K(C(HID_KEYBOARD_SC_MEDIA_NEXT_TRACK)), K(C(HID_KEYBOARD_SC_MEDIA_VOLUME_DOWN)), K(C(HID_KEYBOARD_SC_MEDIA_VOLUME_UP)), K(C(HID_KEYBOARD_SC_MEDIA_PLAY))
    },
    {
        K(SC(US, '`')), K(SC(US, '1')), K(SC(US, '2')), K(SC(US, '3')), K(SC(US, '4')), K(SC(US, '5')), K(SC(US, '6')), K(SC(US, '7')), K(SC(US, '8')), K(SC(US, '9')), K(SC(US, '0')), K(SC(US, BKSP)),
        K(SC(US, DELETE)), K(SC(US, F1)), K(SC(US, F2)), K(SC(US, F3)), K(SC(US, F4)), K(SC(US, F5)), K(SC(US, F6)), K(SC(US, '-')), K(SC(US, '=')), K(SC(US, '[')), K(SC(US, ']')), K(SC(US, '\\')),
        ...
        NO_ACTION, K(SC(US, L_CTRL)), K(SC(US, L_ALT)), K(SC(US, L_GUI)), L(VISIT, 1), K(SC(US, ' ')), K(SC(US, ' ')), L(VISIT, 2), K(C(HID_KEYBOARD_SC_MEDIA_NEXT_TRACK)), K(C(HID_KEYBOARD_SC_MEDIA_VOLUME_DOWN)), K(C(HID_KEYBOARD_SC_MEDIA_VOLUME_UP)), K(C(HID_KEYBOARD_SC_MEDIA_PLAY))
    }
);
