...
LAYOUT(
    ...
    },
    {
        ...
        RESET, K(SC(US, L_CTRL)), K(SC(US, L_ALT)), K(SC(US, L_GUI)), L(VISIT, 1), K(SC(US, ' ')), K(SC(US, ' ')), L(VISIT, 2), C(0xB5), C(0xEA), C(0xE9), C(0xCD)
    },
    {
        ...
        GD(0x81), K(SC(US, L_CTRL)), K(SC(US, L_ALT)), K(SC(US, L_GUI)), L(VISIT, 1), K(SC(US, ' ')), K(SC(US, ' ')), L(VISIT, 2), C(0xB5), C(0xEA), C(0xE9), C(0xCD)
    }
);
