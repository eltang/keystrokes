...
LAYOUT(
    {
        ...
        LEADER_KEY, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)), L(VISIT, 1), K(US_SC(' ')), K(US_SC(' ')), L(VISIT, 2), SA(K(US_SC('a')), K(US_SC('b'))), HTA(K(US_SC(R_SHIFT)),  TDA(K(US_SC('a')), K(US_SC('b')))),  OSA(K(US_SC(R_ALT))), HTA(K(US_SC(R_GUI)),  TDA(NO_ACTION,  OSA(K(US_SC(R_SHIFT)))))
    },
    {
        ...
        RESET, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)), L(VISIT, 1), K(US_SC(' ')), K(US_SC(' ')), L(VISIT, 2),  OSA(K(US_SC(R_CTRL))),  OSA(K(US_SC(R_SHIFT))),  OSA(K(US_SC(R_ALT))),  OSA(K(US_SC(R_GUI)))
    },
    {
        K(US_SC('`')), K(US_SC('1')), K(US_SC('2')), K(US_SC('3')), K(US_SC('4')), K(US_SC('5')), K(US_SC('6')), K(US_SC('7')), K(US_SC('8')), K(US_SC('9')), K(US_SC('0')), K(US_SC(BKSP)),
        K(US_SC(DELETE)),  TDA(K(US_SC(F1)), K(US_SC('q'))), K(US_SC(F2)), K(US_SC(F3)), K(US_SC(F4)), K(US_SC(F5)), K(US_SC(F6)), K(US_SC('-')), K(US_SC('=')), K(US_SC('[')), K(US_SC(']')), K(US_SC('\\')),
