...
LAYOUT(
    [BASE] = LAYER(
        ...
        HT(K(US_SC(L_SHIFT)), K(US_SC('('))), TH(K(US_SC('z')), K(US_SC(L_CTRL))), K(US_SC('x')), K(US_SC('c')), K(US_SC('v')), K(US_SC('b')), HT(K(US_SC(L_C(L_S(L_A(L_G(0)))))), K(US_SC('['))),
        HT(L(VISIT, SYMB), K(US_SC('`'))), K(US_SC('\'')), K(US_SC(L_A(L_S(0)))), K(US_SC(LEFT)), K(US_SC(RIGHT)),
                                                               HT(K(US_SC(L_ALT)), K(US_SC(APP))), K(US_SC(L_GUI)),
                                                                          K(US_SC(HOME)),
        ...
        L(GOTO, SYMB), K(US_SC('y')), K(US_SC('u')), K(US_SC('i')), K(US_SC('o')), K(US_SC('p')), K(US_SC('\\')),
                   K(US_SC('h')), TH(K(US_SC('j')), K(US_SC(R_ALT))), K(US_SC('k')), K(US_SC('l')), TH(K(US_SC(';')), L(VISIT, MDIA)), TH(K(US_SC('\'')), K(US_SC(R_GUI))),
        HT(K(US_SC(R_C(R_S(R_A(0))))), K(US_SC(']'))), K(US_SC('n')), K(US_SC('m')), K(US_SC(',')), K(US_SC('.')), TH(K(US_SC('/')), K(US_SC(R_CTRL))), HT(K(US_SC(R_SHIFT)), K(US_SC(')'))),
                              K(US_SC(UP)), K(US_SC(DOWN)), K(US_SC('[')), K(US_SC(']')), HT(L(VISIT, SYMB), K(US_SC('-'))),
        K(US_SC(R_ALT)), HT(K(US_SC(R_CTRL)), K(US_SC(ESC))),
        K(US_SC(PG_UP)),
        K(US_SC(PG_DN)), HT(L(VISIT, SYMB), K(US_SC(TAB))), K(US_SC(ENTER))
    ),
    [SYMB] = LAYER(
