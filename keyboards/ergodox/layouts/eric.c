...
LAYOUT(
    LAYER(
        ...
        HT(K(US_SC(L_SHIFT)), K(US_SC('('))), K(US_SC(';')), K(US_SC('q')), K(US_SC('j')), K(US_SC('k')), K(US_SC('x')), L(GOTO, 1),
        ...
        NO_ACTION, K(US_SC('b')), K(US_SC('m')), K(US_SC('w')), K(US_SC('v')), K(US_SC('z')), HT(K(US_SC(R_SHIFT)), K(US_SC(')'))),
    ...
    LAYER(
        ...
        HT(K(US_SC(L_SHIFT)), K(US_SC('('))), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, L(GOTO, 2),
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               NO_ACTION, NO_ACTION,
                                                                          NO_ACTION,
        ...
        L(GOTO, 0), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, HT(K(US_SC(R_SHIFT)), K(US_SC(')'))),
                              K(US_SC(R_GUI)), K(US_SC(R_ALT)), K(US_SC(R_CTRL)), NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION,
        NO_ACTION,
        NO_ACTION, NO_ACTION,  NO_ACTION
