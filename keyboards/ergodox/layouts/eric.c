...
LAYOUT(
    LAYER(
        ...
        NO_ACTION, K(US_SC(';')), K(US_SC('q')), K(US_SC('j')), K(US_SC('k')), K(US_SC('x')), L(GOTO, 1),
        NO_ACTION, K(US_SC(L_SHIFT)), K(US_SC(L_GUI)), K(US_SC(L_ALT)), K(US_SC(L_CTRL)),
        ...
        NO_ACTION, K(US_SC('b')), K(US_SC('m')), K(US_SC('w')), K(US_SC('v')), K(US_SC('z')), NO_ACTION,
                              K(US_SC(R_CTRL)), K(US_SC(R_ALT)),K(US_SC(R_GUI)), K(US_SC(R_SHIFT)), NO_ACTION,
        M(0xE2), PM(0x81),
        M(0xE9),
