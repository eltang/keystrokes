...
LAYOUT(
    LAYER(
        K(US_SC(ESC)), K(US_SC('7')), K(US_SC('5')), K(US_SC('3')), K(US_SC('1')), K(US_SC('9')), K(US_SC('`')),
        ...
        K(US_SC(L_SHIFT)), K(US_SC(';')), K(US_SC('q')), K(US_SC('j')), K(US_SC('k')), K(US_SC('x')), L(GOTO, 1),
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               K(US_SC(HOME)), K(US_SC(END)),
                                                                          K(US_SC(PG_UP)),
                                                    K(US_SC(' ')), K(US_SC(BKSP)), K(US_SC(PG_DN)),
        K(US_SC('\\')), K(US_SC('0')), K(US_SC('2')), K(US_SC('4')), K(US_SC('6')), K(US_SC('8')), K(US_SC('=')),
        ...
        NO_ACTION, K(US_SC('b')), K(US_SC('m')), K(US_SC('w')), K(US_SC('v')), K(US_SC('z')), K(US_SC(R_SHIFT)),
    ...
    LAYER(
        ...
        K(US_SC(L_SHIFT)), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, L(GOTO, 2),
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               NO_ACTION, NO_ACTION,
                                                                          NO_ACTION,
        ...
        L(GOTO, 0), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, K(US_SC(R_SHIFT)),
                              K(US_SC(R_GUI)), K(US_SC(R_ALT)), K(US_SC(R_CTRL)), NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION,
        NO_ACTION,
        NO_ACTION, NO_ACTION,  NO_ACTION
