...
LAYOUT(
    ...
    LAYER(
        NO_ACTION, K(SC(US, F11)), K(SC(US, F12)), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION,
        NO_ACTION, K(SC(US, F6)), K(SC(US, F7)), K(SC(US, F8)), K(SC(US, F9)), K(SC(US, F10)) NO_ACTION,
        K(SC(US, ESC)), K(SC(US, F1)), K(SC(US, F2)), K(SC(US, F3)), K(SC(US, F4)), K(SC(US, F5)),
