...
LAYOUT(
    LAYER(
        K(US_SC(ESC)), K(US_SC('1')), K(US_SC('2')), K(US_SC('3')), K(US_SC('4')), K(US_SC('5')), K(US_SC('`')),
        K(US_SC(TAB)), K(US_SC('\'')), K(US_SC(',')), K(US_SC('.')), K(US_SC('p')), K(US_SC('y')), K(US_SC('[')),
        K(US_SC(CAPS_LOCK)), K(US_SC('a')), K(US_SC('o')), K(US_SC('e')), K(US_SC('u')), K(US_SC('i')),
        HTA(K(US_SC(L_SHIFT)), K(US_SC('('))), K(US_SC(';')), K(US_SC('q')), K(US_SC('j')), K(US_SC('k')), K(US_SC('x')), L(GOTO, 1),
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               K(US_SC(HOME)), K(US_SC(END)),
                                                                          K(US_SC(PG_UP)),
                                                    K(US_SC(' ')), K(US_SC(BKSP)), K(US_SC(PG_DN)),
        K(US_SC('\\')), K(US_SC('6')), K(US_SC('7')), K(US_SC('8')), K(US_SC('9')), K(US_SC('0')), K(US_SC('=')),
        ...
        NO_ACTION, K(US_SC('b')), K(US_SC('m')), K(US_SC('w')), K(US_SC('v')), K(US_SC('z')), HTA(K(US_SC(R_SHIFT)), K(US_SC(')'))),
                              K(US_SC(R_GUI)), K(US_SC(R_ALT)), K(US_SC(R_CTRL)), NO_ACTION, NO_ACTION,
        M(0xE2), PM(0x81),
        M(0xE9),
    ...
    LAYER(
        ...
        HTA(K(US_SC(L_SHIFT)), K(US_SC('('))), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, L(GOTO, 2),
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               NO_ACTION, NO_ACTION,
                                                                          NO_ACTION,
        ...
        L(GOTO, 0), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, HTA(K(US_SC(R_SHIFT)), K(US_SC(')'))),
                              K(US_SC(R_GUI)), K(US_SC(R_ALT)), K(US_SC(R_CTRL)), NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION,
        NO_ACTION,
        NO_ACTION, NO_ACTION,  NO_ACTION
