...
LAYOUT(
    LAYER(
        ...
        K(US_SC(ESC)), K(US_SC('\'')), K(US_SC(',')), K(US_SC('.')), K(US_SC('p')), K(US_SC('y')), K(US_SC(BKSP)),
        ...
        NO_ACTION, K(US_SC('[')), K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
        ...
        NO_ACTION, K(US_SC('b')), K(US_SC('m')), K(US_SC('w')), K(US_SC('v')), K(US_SC('z')), K(US_SC('-')),
                              K(US_SC(R_GUI)), K(US_SC(R_ALT)),K(US_SC(R_CTRL)), K(US_SC(']')), NO_ACTION,
        M(0xE2), PM(0x81),
        M(0xE9),
