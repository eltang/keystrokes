...
LAYOUT(
    ...
    LAYER(
        ...
        HT(K(SC(US, L_SHIFT)), K(SC(US, '('))), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, L(GOTO, 2),
        NO_ACTION, NO_ACTION, K(SC(US, L_CTRL)), K(SC(US, L_ALT)), K(SC(US, L_GUI)),
                                                               NO_ACTION, NO_ACTION,
                                                                          NO_ACTION,
                                                    NO_ACTION, NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION, NO_ACTION, K(SC(US, UP)), NO_ACTION, NO_ACTION, NO_ACTION,
                   NO_ACTION, K(SC(US, LEFT)), K(SC(US, DOWN)), K(SC(US, RIGHT)), NO_ACTION, NO_ACTION,
        L(GOTO, 0), NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, HT(K(SC(US, R_SHIFT)), K(SC(US, ')'))),
                              K(SC(US, R_GUI)), K(SC(US, R_ALT)), K(SC(US, R_CTRL)), NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION,
        NO_ACTION,
        NO_ACTION, NO_ACTION,  NO_ACTION
    ...
    LAYER(
        ...
        L(GOTO, 0), NO_ACTION, K(SC(US, NK('1'))), K(SC(US, NK('2'))), K(SC(US, NK('3'))), K(SC(US, NK(ENTER))), NO_ACTION,
                              NO_ACTION, NO_ACTION, K(SC(US, NK('.'))), K(SC(US, NK(ENTER))), NO_ACTION,
        NO_ACTION, NO_ACTION,
        NO_ACTION,
