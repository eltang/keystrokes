...
LAYOUT(
    LAYER(
        ...
        K(US_SC('`')), K(US_SC('\'')), K(US_SC(',')), K(US_SC('.')), K(US_SC('p')), K(US_SC('y')), K(US_SC(BKSP)),
        ...
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               K(US_SC(HOME)), K(US_SC(END)),
                                                                          K(US_SC(PG_UP)),
                                                    K(US_SC(' ')), K(US_SC(L_SHIFT)), K(US_SC(PG_DN)),
        K(US_SC(']')), K(US_SC('0')), K(US_SC('2')), K(US_SC('4')), K(US_SC('6')), K(US_SC('8')), K(US_SC('\\')),
        K(US_SC(ENTER)), K(US_SC('f')), K(US_SC('g')), K(US_SC('c')), K(US_SC('r')), K(US_SC('l')), K(US_SC('=')),
        ...
        M(0xE2), PM(0x81),
        M(0xE9),
        M(0xEA), K(US_SC(R_SHIFT)), K(US_SC(' '))
    ),
    LAYER(
        ...
        NO_ACTION, NO_ACTION, K(US_SC(L_CTRL)), K(US_SC(L_ALT)), K(US_SC(L_GUI)),
                                                               NO_ACTION, NO_ACTION,
                                                                          NO_ACTION,
                                                    NO_ACTION, K(US_SC(L_SHIFT)), NO_ACTION,
        ...
        NO_ACTION, NO_ACTION,
        NO_ACTION,
        NO_ACTION, K(US_SC(R_SHIFT)), NO_ACTION
    ),
    LAYER(
        NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION,
        NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION, NO_ACTION,
